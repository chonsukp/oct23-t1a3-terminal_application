...
from functions import convert_time_to_seconds, view_log
...
def test_convert_time_to_seconds():
    """Test Case 1.0: testing conversion of time to seconds function, as it is used to calculate total time and average pace."""
...
def test_view_log(capsys):
    """Test Case 1.1: Testing the View log function using capsys fixture provided by pytest."""
    # Creating a test CSV file.
    with open("test_runs.csv", "w") as f:
